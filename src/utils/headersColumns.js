...
export const tableColumnsClientes = [
    ...
    { ID: 1, CAPTION: 'Titular', VALUE: 'titular', TYPE: 'VARCHAR2', FORMAT: '', WIDTH: 150, FIXED: true },
    ...
    { ID: 7, CAPTION: 'Dirección cobro', VALUE: 'dir_cobro', TYPE: 'VARCHAR2', FORMAT: '', WIDTH: 150, FIXED: false },
    { ID: 8, CAPTION: 'Barrio cobro', VALUE: 'barrio_cobro', TYPE: 'VARCHAR2', FORMAT: '', WIDTH: 150, FIXED: false },
    { ID: 9, CAPTION: 'Dirección casa', VALUE: 'dir_casa', TYPE: 'VARCHAR2', FORMAT: '', WIDTH: 150, FIXED: false },
    { ID: 10, CAPTION: 'Barrio casa', VALUE: 'barrio_casa', TYPE: 'VARCHAR2', FORMAT: '', WIDTH: 150, FIXED: false },
