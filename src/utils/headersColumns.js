...
export const tableColumnsClientes = [
    ...
    { ID: 4, CAPTION: 'Fiador', VALUE: 'fiador', TYPE: 'VARCHAR2', FORMAT: '', WIDTH: 250, FIXED: false },
    { ID: 5, CAPTION: 'Identificación  fiador', VALUE: 'cc_fiador', TYPE: 'VARCHAR2', FORMAT: '', WIDTH: 150, FIXED: false },
    { ID: 6, CAPTION: 'Negocio titular', VALUE: 'neg_titular', TYPE: 'VARCHAR2', FORMAT: '', WIDTH: 250, FIXED: false },
